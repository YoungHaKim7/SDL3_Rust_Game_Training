...
# justfile(macOS) Opengl(GLUT)
- https://stackoverflow.com/questions/18372651/compiling-opengl-and-glut-osx
...
opencv_optimize := "-Wall -O2 -pedantic -L/System/Library/Frameworks -framework GLUT -framework OpenGL"
...
ro:
	rm -rf target
	mkdir -p target
	clang {{opencv_optimize}} -o {{target}} {{source}}
	{{target}}
