...
- GameMath
  - [(250205)What Kind of Math Should Game Developers Know? | SimonDev](https://youtu.be/eRVRioN4GwA?si=ki0K7KPrEcfgZR1x)
...
# (LinuxOS Install)What you need to do to install SDL is:[|🔝|](#link)
